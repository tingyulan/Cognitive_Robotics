...
class CozmoKinematics(Kinematics):
    def __init__(self,robot):
        ...
        # Self defined 
        left_front_wheel_frame = Joint('left_front_wheel', parent=front_axle_frame,
        					description='z to the right, x point forward',
        					d = -22.)
        
        right_front_wheel_frame = Joint('right_front_wheel', parent=front_axle_frame,
        					description='z to the right, x point forward',
        					d = +22.)

       	left_hook_dummy = Joint('left_hook_dummy', parent=lift_attach_frame, 
       									description='Dummy joint for left hook',
       									d = -20., alpha=-pi/2)

       	left_hook_frame = Joint('left_hook', parent=left_hook_dummy, 
       									description='left hook',
       									d = -20.)

       	right_hook_dummy = Joint('right_hook_dummy', parent=lift_attach_frame, 
       									description='Dummy joint for right hook',
       									d = 20., alpha=-pi/2)

       	right_hook_frame = Joint('right_hook', parent=right_hook_dummy, 
       									description='right hook',
       									d = -20.)

        focal_plane_frame = Joint(name='focal_plane', parent='camera', d=100.)
        ...
        joints = [base_frame, world_frame, cor_frame,
                  ...
                  left_front_wheel_frame, right_front_wheel_frame,
                  left_hook_dummy, left_hook_frame, right_hook_dummy, right_hook_frame,
                  focal_plane_frame]
